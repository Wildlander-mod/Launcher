...
import { checkValidModDirectory } from "./paths";
...
export function registerHandlers() {
  ...
  ipcMain.handle(IPCEvents.CHECK_MOD_DIRECTORY, async (_event, filepath) => {
    return await checkValidModDirectory(filepath);
  });
