...
float fBloomCurve < string UIName="BloomCurve"; string UIWidget="Spinner"; float UIMin=-4.0; float UIMax=4.0; > = 0.4;		       	
// Controls spread of brighter parts of bloom. Higher = Wider. Range is 0.1-2.

float fBloomDistance < string UIName="BloomDistance"; string UIWidget="Spinner"; float UIMin=-10.0; float UIMax=10.0; > = 6;						
// Controls initial spread of bloom samples (in pixels). Range is 1.0+.

float fBloomMult1 < string UIName="Amount"; string UIWidget="Spinner"; float UIMin=-4.0; float UIMax=4.0; > = 0.0;        	 	
// Controls the amount of original image in bloom. Range is 0-1.

float fBloomMult2 < string UIName="Initial Blur"; string UIWidget="Spinner"; float UIMin=-4.0; float UIMax=4.0; > = 1.0;         		
// Controls the amount of the initial blur spread in bloom. Range is 0-1.

float fBloomMult3 < string UIName="10px Blur"; string UIWidget="Spinner"; float UIMin=-4.0; float UIMax=4.0; > = 0.86;         	
// Controls the amount of 10px blur. Range is 0-1.

float fBloomMult4 < string UIName="20px Blur"; string UIWidget="Spinner"; float UIMin=-4.0; float UIMax=4.0; > = 0.64;         	
// Controls the amount of 20px blur. Range is 0-1.

float fBloomMult5 < string UIName="40px Blur"; string UIWidget="Spinner"; float UIMin=-4.0; float UIMax=4.0; > = 0.32;         	
// Controls the amount of 40px blur. Range is 0-1.

float fBloomMult6 < string UIName="80px Blur"; string UIWidget="Spinner"; float UIMin=-4.0; float UIMax=4.0; > = 0.16;         	
// Controls the amount of 80px blur. Range is 0-1.

float fBloomMult7 < string UIName="160px Blur"; string UIWidget="Spinner"; float UIMin=-4.0; float UIMax=4.0; > = 0.08;         	
// Controls the amount of 160px blur. Range is 0-1.

float fBloomMult8 < string UIName="320px Blur"; string UIWidget="Spinner"; float UIMin=-4.0; float UIMax=4.0; > = 0.04;         	
