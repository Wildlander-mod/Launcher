...
- **Plans should show the code they are going to produce** with detailed implementation examples
- Include key code snippets that will be created or modified during implementation
